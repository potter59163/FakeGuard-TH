...
export default function BackendWaker() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#FBF7EE]/95 backdrop-blur-sm">
      <div className="mx-4 max-w-sm rounded-3xl border-2 border-green-200 bg-white p-8 text-center shadow-xl">
        {status === "waking" ? (
          <>
          ...
          <>
            ...
            <button
              onClick={startWaking}
              className="mt-4 rounded-full bg-green-600 px-6 py-2.5 font-semibold text-white hover:bg-green-700"
            >
              ลองปลุกอีกครั้ง
            </button>
          </>
